...
const char *gengetopt_args_info_help[] = {
  ...
  "      --dict=dictfile           requer nome de dicionário de dados",
  "      --threads=INT             number of threads, defaults to number of cores",
  "\n Group: ops\n  an operation required",
  "      --decode=codfile          requer nome de ficheiro",
  "      --decode-dir=foldername   requer nome de pasta",
  "      --encode=filename         requer nome de ficheiro",
  "      --parallel-encode=filename\n                                requer nome de ficheiro",
  "      --PSNR=STRING             requer nome do ficheiro original e codificado",
  "  -a, --about                   nome dos autores",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->dict_help = gengetopt_args_info_help[2] ;
  ...
  args_info->encode_help = gengetopt_args_info_help[7] ;
  args_info->parallel_encode_help = gengetopt_args_info_help[8] ;
  args_info->PSNR_help = gengetopt_args_info_help[9] ;
  args_info->PSNR_min = 2;
  args_info->PSNR_max = 2;
  args_info->about_help = gengetopt_args_info_help[10] ;
...
static void
reset_group_ops(struct gengetopt_args_info *args_info)
{
  if (! args_info->ops_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->PSNR_given, args_info->PSNR_min, args_info->PSNR_max, "'--PSNR'"))
     error_occurred = 1;
  
  
  /* checks for dependences among options */
  if (args_info->threads_given && ! args_info->parallel_encode_given)
    {
      fprintf (stderr, "%s: '--threads' option depends on option 'parallel-encode'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->decode_given && ! args_info->dict_given)
    {
      fprintf (stderr, "%s: '--decode' option depends on option 'dict'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->decode_dir_given && ! args_info->dict_given)
    {
      fprintf (stderr, "%s: '--decode-dir' option depends on option 'dict'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "decode-dir",	1, NULL, 0 },
        { "encode",	1, NULL, 0 },
        { "parallel-encode",	1, NULL, 0 },
        { "PSNR",	1, NULL, 0 },
        { "about",	0, NULL, 'a' },
        { 0,  0, 0, 0 }
      };

      c = getopt_long (argc, argv, "hVa", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* nome dos autores.  */
        
          if (args_info->ops_group_counter && override)
            reset_group_ops (args_info);
          args_info->ops_group_counter += 1;
        ...
        case 0:	/* Long option with no short option */
          /* requer nome de dicionário de dados.  */
          if (strcmp (long_options[option_index].name, "dict") == 0)
          {
          ...
          /* requer nome de pasta.  */
          else if (strcmp (long_options[option_index].name, "decode-dir") == 0)
          {
          ...
          /* requer nome de ficheiro.  */
          else if (strcmp (long_options[option_index].name, "parallel-encode") == 0)
          {
          ...
          /* requer nome do ficheiro original e codificado.  */
          else if (strcmp (long_options[option_index].name, "PSNR") == 0)
          {
  ...
  if (args_info->ops_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group ops were given. At most one is required%s.\n", argv[0], args_info->ops_group_counter, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
